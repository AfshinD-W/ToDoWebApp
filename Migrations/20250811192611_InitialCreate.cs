        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "Unknown user"),
                    Email = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ConfirmedEmail = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    Password = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Age = table.Column<int>(type: "int", nullable: true),
                    ImagePath = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Y:\\logo.png")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskHistories_TodoTasks_TodoTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskHistories_TodoTaskId",
                table: "TaskHistories",
                column: "TodoTaskId");
